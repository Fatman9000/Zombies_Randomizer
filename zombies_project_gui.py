...
while True:
    ...
    if (
        ...
        and pygame.mouse.get_pos()[0] <= 600
        and pygame.mouse.get_pos()[1] >= 200
        and pygame.mouse.get_pos()[1] <= 600
        and second_screen == False
        and previous_click == False
        and Click[0]
    ):
        second_screen = True
    ...
    if second_screen:
        ...
        # Redo Button
        if (
            pygame.mouse.get_pos()[0] >= 690
            and pygame.mouse.get_pos()[0] <= 790
            and pygame.mouse.get_pos()[1] >= 10
            and pygame.mouse.get_pos()[1] <= 60
            and previous_click == False
            and Click[0]
        ):
            mapNumber = random.randint(0, 8)
        ...
        PygameTWF.renderTextWrap(
            (extraInfo.challenge_descriptions[challengeNumber]),
            Type2,
            (0, 0, 0),
            795,
            window,
        ...
        challengeName = Type2.render(
            str(extraInfo.challenge[challengeNumber]), True, (0, 0, 0)
        )
        ...
        # Extra info on hover
        if (
            pygame.mouse.get_pos()[0] < 435
            and pygame.mouse.get_pos()[1] > 105
            ...
            PygameCTBF.cursorTextBox(
                (extraInfo.extra_info_desc[displayExtraInfo]),
                Type3,
                (0, 0, 0),
                200,
                window,
